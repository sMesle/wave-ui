...
div
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items"&gt;&lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items" color="orange"&gt;&lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
          { label: 'Sitemap', route: '/sitemap' },
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items" separator-color="orange"&gt; &lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
          { label: 'Sitemap', route: '/sitemap' },
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items" icon="mdi mdi-arrow-right"&gt;&lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
          { label: 'Sitemap', route: '/sitemap' },
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items"&gt;
        &lt;template #item="{ item, isLast }"&gt;
          &lt;w-tag :color="isLast ? 'grey' : 'green' round outline v-html="item.label"&gt;&lt;/w-tag&gt;
        &lt;/template&gt;
      &lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs :items="items" link-last-item&gt;&lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
          { label: 'Sitemap', route: '/sitemap' },
  ...
  example
    ...
    template(#html).
      &lt;w-breadcrumbs class="my-4" :items="items" xs&gt;&lt;/w-breadcrumbs&gt;
      &lt;w-breadcrumbs class="my-4" :items="items" sm&gt;&lt;/w-breadcrumbs&gt;
      &lt;w-breadcrumbs class="my-4" :items="items" md&gt;&lt;/w-breadcrumbs&gt;
      &lt;w-breadcrumbs class="my-4" :items="items" lg&gt;&lt;/w-breadcrumbs&gt;
      &lt;w-breadcrumbs class="my-4" :items="items" xl&gt;&lt;/w-breadcrumbs&gt;
    template(#js).
      data: () => ({
        items: [
          { label: 'Sitemap', route: '/sitemap' },
